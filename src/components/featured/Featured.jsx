...
const Featured = () => {
  return (
    <div className='mt-[30px]'> 
      <h1 className='text-8xl font-light'><b>Lorem ipsum dolor sit! </b> amet consectetur adipisicing elit. </h1>
      <div className='flex items-center gap-[50px] mt-[60px]'> 
        ...
        <div className='flex-1 flex flex-col gap-4'>
          ...
          <button className='py-4 px-5 border-none rounded-[5px] cursor-pointer w-max bg-[#dcdcdc] text-black'>Read More</button>
        </div>
      </div>
    </div>
  )
